# """
# URL configuration for BigBuy project.
...
#         title="BigBuy API",
#         default_version="v1",
#         description="API documentation for BigBuy",
#         terms_of_service="https://www.bigbuy.com/terms/",
#         contact=openapi.Contact(email="support@bigbuy.com"),
...
#     path("api/", include("BigBuyAPI.urls")),
#     path(
